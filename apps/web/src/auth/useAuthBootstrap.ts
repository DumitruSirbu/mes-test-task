...
import type { IAuthenticatedUser, IAuthTokenResponse } from '@mes/shared';
 ...
 * 1. One-shot eviction of any stale localStorage keys from pre-M10 sessions.
 * 2. POST /auth/refresh — on failure, resolve as 'ready' (route guards redirect to /login).
